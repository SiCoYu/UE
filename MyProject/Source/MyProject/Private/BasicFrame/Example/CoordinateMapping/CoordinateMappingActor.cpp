...
//ACoordinateMappingActor::ACoordinateMappingActor(const FObjectInitializer& PCIP)
//	: Super(PCIP)
//{
//
//}

void ACoordinateMappingActor::UpdateBonesOne(float DeltaSeconds)
{
...
void ACoordinateMappingActor::UpdateBonesTwo(float DeltaSeconds)
{
