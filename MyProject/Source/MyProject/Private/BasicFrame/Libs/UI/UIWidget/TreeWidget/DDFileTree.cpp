...
void SDDFileTree::Construct(const FArguments& Args, TWeakObjectPtr<class UMyEngine> IN_DDEdEngine)
{
	...
	*/
	...
	// error C2248: 'FSlotBase::Widget': cannot access private member declared in class 'FSlotBase'
...
void SDDFileTree::DDFileTree_OnSelectionChanged(FDDFileTreeItemPtr Item, ESelectInfo::Type SelectInfo)
{
	...
	UE_LOG(MFileTree_LogCategory, Warning, TEXT("Item Selected: %s"), *Item->GetDisplayName());
}
