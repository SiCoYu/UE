...
bool MyTCPSocket::StartTCPReceiver(
...
bool MyTCPSocket::FormatIP4ToNumber(const FString& TheIP, uint8(&Out)[4])
{
	//IP Formatting
...
FSocket* MyTCPSocket::CreateTCPConnectionListener(const FString& YourChosenSocketName, const FString& TheIP, const int32 ThePort, const int32 ReceiveBufferSize)
{
	uint8 IP4Nums[4];
...
//		#include <string>
FString MyTCPSocket::StringFromBinaryArray(const TArray<uint8>& BinaryArray)
{
...
void MyTCPSocket::TCPSocketListener()
{
	//~~~~~~~~~~~~~
...
void MyTCPSocket::ConnectThirdPartySocketServer()
{
...
void MyTCPSocket::SendThirdPartyData()
{
