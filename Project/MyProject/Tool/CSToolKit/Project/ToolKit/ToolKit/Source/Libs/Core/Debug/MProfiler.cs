namespace SDK.Lib
{
    ...
    public class MProfiler
	{
		...
		public void exit(string blockName)
		{
            ...
            // 更新这个 node 的状态
            double currentTime = UtilSysLibWrap.getFloatUTCMilliseconds();
		...
		private void reportNode(MProfileInfo profileInfo, int indent)
		{
            ...
            foreach (System.Collections.Generic.KeyValuePair<string, MProfileInfo> kv in profileInfo.mChildren.getData())
			{
