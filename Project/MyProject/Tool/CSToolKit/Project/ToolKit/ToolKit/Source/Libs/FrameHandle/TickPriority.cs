namespace SDK.Lib
{
    ...
    public class TickPriority
    {
        ...
        public static float eTPBoomPlaneMgr = 10;    // BoomPlaneMgr
        public static float eTPScoreEffectMgr = 10;    // ScoreEffectMgr
        public static float eTPMeteStoneMgr = 10;    // MeteStoneMgr
        ...
        public static float eTPSYstemCheck = 0;
        public static float eTPSNodeNumAnimSys = 0;
        public static float eTPUIProfilerInfo = 0;


        // 服务器定时器
        public static float eTPServerPlayerMgr = 10;       // PlayerMgr
        public static float eTPServerSnowBlockMgr = 10;    // SnowBlockMgr
        public static float eTPTwoDSceneTileMgr = 10;    // TwoDSceneTileMgr
    }
}