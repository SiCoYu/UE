	...
	: Super(PCIP)
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> StaticMeshOb_AW2(TEXT("StaticMesh'/Game/MyAsset/MyTP/ThirdPerson/Meshes/Bump_StaticMesh.Bump_StaticMesh'"));
	...
	// ACharacter 才有 class USkeletalMeshComponent* Mesh;
