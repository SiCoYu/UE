...
#include "MyTomSaveGame.generated.h"
...
UCLASS()
class UMyTomSaveGame : public UMySaveGameBase
{
	GENERATED_UCLASS_BODY()

//public:
//	/** Loads user persistence data if it exists, creates an empty record otherwise. */
//	static UMyTomSaveGame* LoadPersistentUser(FString SlotName, const int32 UserIndex);
//
//private:
