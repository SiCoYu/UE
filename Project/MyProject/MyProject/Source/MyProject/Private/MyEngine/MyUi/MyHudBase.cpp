...
void AMyHudBase::OnConfirmGeneric()
{
...
void AMyHudBase::DrawHUD_ChatSystem()
{
	if (!MyPC)
	{
...
void AMyHudBase::AddMessageBP(const int32 Type, const FString& Username, const FString& Text, const bool Replicate)
{
...
void AMyHudBase::BeginPlay_LoadStyleWidget()
{
	////////////////////////////////////////////////////////////////////////////////////////////////////
...
void AMyHudBase::JoyInit_VictoryChat()
{
...
//  Set Font
//~~~~~~~~~~~~
void AMyHudBase::SetChatFont(FString NewFontPath)
{
	if (!VictoryChat.IsValid()) 			return;
...
// Draw HUD
//~~~~~~~~~~~~
void AMyHudBase::DrawHUD_EditText()
{
	Super::DrawHUD();
	//~~~~~~~~~
...
void AMyHudBase::BeginPlay_SlateTab()
{
